...
export function ProjectProvider({ children }: { children: React.ReactNode }) {
  ...
  // Estado inicial con proyectos por defecto
  const [projects, setProjects] = useState<Project[]>([
    { id: 'suma-os', name: 'Suma OS' },
    { id: 'mvp-tms', name: 'MVP TMS Integration' }
  ]);

  // Función para crear proyecto con slug automático
  ...
  // Función para eliminar proyecto con redirección de seguridad
  const deleteProject = (id: string) => {
    ...
    // Si borramos el proyecto donde estamos parados, volvemos al primero de la lista
