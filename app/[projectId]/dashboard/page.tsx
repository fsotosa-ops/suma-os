...
// --- CORRECCIONES DE RUTAS AQUÍ ---
// Antes: import { useStrategy } from '@/app/strategy/context/StrategyProvider';
import { useStrategy } from '../strategy/context/StrategyProvider';
import { useDiscovery } from '../discovery/context/DiscoveryProvider';
...
export default function BusinessDashboardPage() {
  ...
  const { sprints, tickets } = useExecution();
